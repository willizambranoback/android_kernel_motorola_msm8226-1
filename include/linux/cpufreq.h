...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_INTERACTIVENOPH)
extern struct cpufreq_governor cpufreq_gov_interactivenoph;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_interactivenoph)
